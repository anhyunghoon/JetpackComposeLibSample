...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    /**
     * Dependency provider for <b>mylibrary</b> with <b>com.github.anhyunghoon:JetpackComposeLibSample</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getMylibrary() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return create("mylibrary");
    }
    ...
    public static class AndroidLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>maven</b> with <b>com.github.dcendents:android-maven-gradle-plugin</b> coordinates and
         * with version <b>2.1</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class UiToolingLibraryAccessors extends SubDependencyFactory {
        private final UiToolingPreviewLibraryAccessors laccForUiToolingPreviewLibraryAccessors = new UiToolingPreviewLibraryAccessors(owner);

        public UiToolingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>ui.tooling.preview</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public UiToolingPreviewLibraryAccessors getPreview() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForUiToolingPreviewLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class UiToolingPreviewLibraryAccessors extends SubDependencyFactory {

        public UiToolingPreviewLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>androidx.compose.ui:ui-tooling-preview-android</b> coordinates and
         * with version reference <b>uiToolingPreviewAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("ui.tooling.preview.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>uiToolingPreviewAndroidVersion</b> with value <b>1.6.6</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getUiToolingPreviewAndroidVersion() { return getVersion("uiToolingPreviewAndroidVersion"); }
